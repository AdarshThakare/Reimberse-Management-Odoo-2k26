    ...
    <div className="flex min-h-screen items-center justify-center px-4" style={{ background: "linear-gradient(135deg, #F6F8FC 0%, #ECE9EA 100%)" }}>
      <div className="animate-fade-in w-full max-w-lg">
        <div className="mb-8 text-center">
          {/* Logo */}
          <div className="mx-auto mb-6 flex h-14 w-14 items-center justify-center rounded-2xl" style={{ background: "linear-gradient(135deg, #3872E1, #00DDB0)", boxShadow: "0 8px 24px rgba(56, 114, 225, 0.3)" }}>
